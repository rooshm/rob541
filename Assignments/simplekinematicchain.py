...
from geomotion import representationliegroup as rplg
import numpy as np
...
class KinematicChain:
    ...
    def __init__(self,
                 links: List[rplg.RepresentationLieGroupElement],  # List of SE2 group elements
                 joint_axes: List[rplg.RepresentationLieGroupTangentVector]):  # List of SE2 Lie algebra elements
        ...
        self.joint_angles: np.ndarray = np.zeros(len(joint_axes))
        ...
        self.joint_transforms: List[rplg.RepresentationLieGroupElement] = [G.identity_element()] * len(joint_axes)
        ...
        self.link_positions: List[rplg.RepresentationLieGroupElement] = [G.identity_element()] * (len(links))
    ...
    def set_configuration(self,
        ...
        for i, alpha in enumerate(joint_angles):
            ...
            scaled_axis: rplg.RepresentationLieGroupTangentVector = alpha * self.joint_axes[i]
