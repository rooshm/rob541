...
ax.set_title("Left-invariant field left_shifted")
...
ax.set_title("Right-invariant field left_shifted")
...
ax.set_title("Left-invariant field right_shifted")
...
ax.set_title("Right-invariant field right_shifted")
