...
param_map = md.ManifoldMap(Q_amb, Q, [ambient_to_cartesian, None], [0, 0])
embed_map = md.ManifoldMap(Q, Q_amb, [cartesian_to_ambient, None], [0, 0])
...
f_monkey_saddle = md.ManifoldFunction(Q, [None, monkey_saddle])
